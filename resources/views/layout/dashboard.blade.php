    ...
    <div class="row">
        ...
        <div class="col-md-6 col-xl-4">
            <div class="card mb-3 widget-content bg-arielle-smile">
                <div class="widget-content-wrapper text-white">
                    <div class="widget-content-left">
                        <div class="widget-heading">Tổng Giá Trị</div>
                        <div class="widget-subheading">Total Orders price</div>
                    </div>
                    <div class="widget-content-right">
                        <div class="widget-numbers text-white"><span>$ {{$totalPrice}}</span></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-xxl-6">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link active" id="tab1-tab" data-bs-toggle="tab" href="#tab1">Doanh thu bán hàng</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="tab2-tab" data-bs-toggle="tab" href="#tab2">Nhập hàng</a>
                </li>
              </ul>
                ...
                <div class="card-header-tab card-header">
                    ...
                    <div class="btn-actions-pane-right">
                        <div class="nav">
                            ...
                            <a href="javascript:void(0);" class="ml-1 btn-pill btn-wide border-0 btn-transition btn btn-outline-alternate second-tab-toggle-alt">Nhập Hàng</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
...
<script>
    ...
    const tabLinks = document.querySelectorAll('.card-header-tab .nav .btn');
    ...
    tabLinks.forEach(function(link) {
        link.addEventListener('click', function(e) {
            ...
            // Xóa lớp "active" và "show" cho tất cả các tab
            ...
            // Thêm lớp "active" và "show" cho tab được nhấp và nội dung tương ứng
    ...
    var saleChartData = @json($saleChartData);
    var importChartData = @json($importChartData);
    var chartOptions = @json($chartOptions);

    // Tạo biểu đồ cho tab 1 (sale-chart)
    var saleChart = new Chart(document.getElementById('sale-chart'), {
        type: 'bar',
        data: saleChartData,
        options: chartOptions
    });

    // Tạo biểu đồ cho tab 2 (import-chart)
    var importChart = new Chart(document.getElementById('import-chart'), {
        type: 'bar',

...
<head>
    ...
    <link rel="shortcut icon" href="https://snipstock.com/assets/cdn/png/3ca7917ad1c4ea04798400a71f688231.png"
        type="image/x-icon">
    <link href="{{ asset('resources/css/bootstrap.min.css') }}" rel="stylesheet" integrity="" crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.4/font/bootstrap-icons.css">
    {{-- <script src="{{asset('resources/js/bootstrap.bundle.min.js')}}" integrity="" crossorigin="anonymous"></script> --}}

    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.2/dist/umd/popper.min.js"
        integrity="sha384-IQsoLXl5PILFhosVNubq5LC7Qb9DXgDA9i+tQ8Zj3iwWAwPtgFTxbJ8NT4GN1R8p" crossorigin="anonymous">
    </script>
    <script src="{{ asset('resources/js/bootstrap.min.js') }}" integrity="" crossorigin="anonymous"></script>
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="{{asset('/resources/images/avatar.svg')}}"
                                                alt="">
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <a href="{{url('store/dashboard')}}" class="w-100 mm-active ">
                                    Dashboard
                                </a>
                            </li>
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <a href="{{ url('store/Products') }}" class="w-100">
                                    Danh sách sản phẩm
                                </a>
                            </li>
                            <li class="d-flex align-items-center">
                                <i class="bi bi-plus-square" ></i>
                                <a href="{{url('store/Products/create')}}" class="w-100" >
                                    Thêm sản phẩm mới
                                </a>
                            </li>
                            <li class="app-sidebar__heading">Nhóm hàng</li>
                            <li class="d-flex align-items-center">
                                <i class="bi bi-grid-3x3-gap"></i>
                                <a href="{{url('store/categories')}}" class="w-100">
                                    Danh sách nhóm hàng
                                </a>
                            </li>
                            <li class="d-flex align-items-center">
                                <i class="bi bi-plus-square"></i>
                                <a href="{{url('store/categories/create')}}" class="w-100">
                                    Thêm nhóm hàng mới
                                </a>
                            </li>
                            ...
                            <li class="d-flex align-items-center">
                                <i class="bi bi-bag"></i>
                                <a href="{{url('store/Orders')}}" class="w-100">
                                    Danh sách đơn hàng
                                </a>
                            </li>
                            <li class="d-flex align-items-center">
                                <i class="bi bi-plus-square"></i>
                                <a  href="{{url('store/Orders/create')}}" class="w-100">
                                    Thêm đơn hàng mới
                                </a>
                            </li>
                        </ul>
                    ...
                    <footer class="bg-dark text-light py-5">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4">
                                    <h5>Liên hệ</h5>
                                    <p>Địa chỉ: 123 Nguyễn Văn Linh, Quận Thanh Khê, TP. Đà Nẵng</p>
                                    <p>Điện thoại: 0123 456 789</p>
                                    <p>Email: info@camera.com</p>
                                </div>
                                <div class="col-md-4">
                                    <h5>Về chúng tôi</h5>
                                    <p>Chúng tôi là cửa hàng bán máy ảnh chuyên nghiệp với nhiều năm kinh nghiệm.</p>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <p>© 2023 Camera Shop. All rights reserved.</p>
                                </div>
